...
This is a document for Computer Modeling Week 7a lab to explore making maps in R. The data set for this document can be found in the [Plastic Pollution](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-01-26/readme.md) page from R for Data Science's Tidy Tuesday repository.
...
* This plastics data comes form **"Break Free of Plastic"**, courtesy of Sarah Sauve.  
...
# Map plastic pollution by country
